...
class TestList(unittest.TestCase):
    ...
    def test_node_lt_02(self) -> None:
        node1 = HuffmanNode(100, 230)
        node2 = HuffmanNode(100, 230)
    ...
    def test_create_codes_03(self) -> None:
        huffman_tree = HuffmanNode(97, 15)
        codes = create_codes(huffman_tree)
    ...
    def test_create_header_03(self) -> None:
        ...
        self.assertEqual(create_header(frequencies), '97 5')
    ...
    def test_huffman_encode_03(self) -> None:
        with open('text_files/multiline.txt') as in_file, \
                open('out_file_test.txt', 'w') as out_file:
            huffman_encode(in_file, out_file)

        with open('out_file_test.txt') as student_out, \
